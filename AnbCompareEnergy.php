                                ...
                                <div class='form-group family-members-container'>
                                    ...
                                    <div class='family-members'>
                                        <fieldset class='person-sel-sm'>
                                            ...
                                            <input type='radio' id='person2' name='f' value='2' checked usage-val='".KWH_2_PERSON."' usage-val-night='".KWH_2_PERSON_NIGHT."' usage-night-ex='".KWH_2_PERSON_NIGHT_EX."' ". (($values['f'] === '2') ? 'checked="checked"' : '') .">
