...
class AnbCompareEnergy extends AnbCompare
{
    ...
    function moreResults(){
        ...
        foreach ($results->results as $listProduct) :
            ...
            $productResp .= '</div>';
            $productResp .= '<div class="cols">' .$anbTopDeals->getPromoSection( $productData ). '</div>';
            $productResp .= '<div class="cols">';
            ...
            $productResp .= '<div class="pull-left">'.decorateLatestOrderByProduct($product->product_id) . '</div>';
            $productResp .= '<div class="pull-right">'.$anbTopDeals->getLastUpdateDate( $productData ).'</div>';
            $productResp .= '</div>';
            $productResp .= '</div>';
            $endScriptTime = getEndTime();
